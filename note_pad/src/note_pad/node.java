...
//Basit bir Window Uygulamasý


//BufferReader ile ilgili internetten faydalanmaya çalýþtýðým siteler: Ama bu aþaðýdaki üç siteden biþey kullanmadým sanýrým.
...
GridBagConstraints b=new GridBagConstraints();
    ...
    Button b1,b2,b3,b4;
     ...
     int i=0,satýr_x=70,satýr_y=-180;
    ...
    public node(String title){
		...
		//Bu siteden Scanner sýnýfýnýn satýr satýr okuma'sýnýn kullanýmýna baktým ve uyfuladým kod üzerinde.
...
//C:\Users\ok\Desktop\Staj_baktýgým_þirketler.txt
                 if(s.equals("LOAD")) {
                 	input.setText("");
			path=c.getText();
		try
...
while ((line = rd.readLine()) != null)
    input.append(line + "\n");// textArea'ya yazýyo bütüne satýrlarý
rd.close();
			}
		catch(Exception u)
			{
					input.setText("Beklenmedik bir problem oluþtu.");	
			}  
                 }
		...
		catch(Exception u)
		{
			...
			islem.setPrintable((node) this);// bu kullanýmý--> "(notepad_printable) this" , internetten buldum.
